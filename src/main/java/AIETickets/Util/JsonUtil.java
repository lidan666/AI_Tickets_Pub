...
public class JsonUtil {
     ...
     * @return  bean灞炴�ч泦鍚�
     */
    public static HashMap<Object,Object> getBean(String str, HashMap<Object,Object> map){	
    	if(str.indexOf(",")==-1)
    	{
     ...
     * @return  bean瀵硅薄闆嗗悎
     */
    public static ArrayList<HashMap<Object,Object>> getBeanList(String str,ArrayList<HashMap<Object, Object>> list)
    {
    	if(str.indexOf("}")==-1)
    		return list;
    	else
...
//    	String str="\"categoryId\":\"1\",\"categoryName\":\"楗搧\",\"categoryImage\":\"/upload/yinpin.jpg\"";
