...
<div id="page-inner">
    <div class="header">
        <h1 class="page-header">
            训练过程日志管理 <small>Training Process Log Management</small>
        </h1>
    </div>
...
<div id="page-inner">
    <div class="panel panel-default">
        <div class="panel-heading">
            任务选择
            <div class="btn-group">
                <button data-toggle="dropdown" class="btn btn-default dropdown-toggle">任务名<span class="caret"></span></button>
            ...
            数据选择
            <div class="btn-group">
                <button data-toggle="dropdown" class="btn btn-default dropdown-toggle">数据名<span class="caret"></span></button>
                <ul class="dropdown-menu">
                    <li><a href="#">数据1</a></li>
                    <li><a href="#">数据2</a></li>
                    <li><a href="#">数据3</a></li>
