...
<div id="page-inner">
    <div class="header">
        <h1 class="page-header">
            训练过程管理 <small>Training Process Management</small>
        </h1>
    </div>
        ...
        <div class="panel-heading">
            ...
            <div class="form-group">
                <form class="form-inline">
                    <label for="exampleInputName2">训练参数超参配置</label>
                    <input type="text" class="form-control" id="exampleInputName1" placeholder="参数超参配置">
                </form>
            </div><br/>
            <div class="form-group">
                <form class="form-inline">
                    <label for="exampleInputName2">数据训练损失配置</label>
                    <input type="text" class="form-control" id="exampleInputName2" placeholder="训练损失配置">
                </form>
            </div><br/>
            ……<br/>
